...
class CheckOutController extends Controller
{
  /**
  *@param Request
  *Display the chechout page if the request is not POST.
  *If the request is POST, then the payement proceed via the Stripe API.
  *If the payement is accepted the session (reservation) is going to the DB and emptied, the visitor is redirected to the succes page.
